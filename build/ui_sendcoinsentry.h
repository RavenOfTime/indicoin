...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        label->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);

        gridLayout->addWidget(label, 5, 0, 1, 1);

        label_2 = new QLabel(SendCoinsEntry);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);
        ...
        label_4->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);
        ...
        payTo->setProperty("maxLength", QVariant(100));
