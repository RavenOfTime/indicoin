...
public:
    ...
    void setupUi(QWidget *SignVerifyMessageDialog)
    {
        ...
        SignVerifyMessageDialog->setWindowModality(Qt::ApplicationModal);
    ...
    void retranslateUi(QWidget *SignVerifyMessageDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this indicoin address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified indicoin address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
