...
public:
    ...
    void setupUi(QFrame *MultisigAddressEntry)
    {
        ...
        pubkeyLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);
        ...
        addressLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);
        ...
        labelLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);
