...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to indicoin-qt.", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where indicoin-qt will store its data.", 0, QApplication::UnicodeUTF8));
        sizeWarningLabel->setText(QApplication::translate("Intro", "indicoin-qt will download and store a copy of the indicoin block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", 0, QApplication::UnicodeUTF8));
