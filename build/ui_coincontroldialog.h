...
public:
    ...
    void setupUi(QWidget *CoinControlDialog)
    {
    ...
    void retranslateUi(QWidget *CoinControlDialog)
    {
        ...
        ___qtreewidgetitem->setText(6, QApplication::translate("CoinControlDialog", "Weight", 0, QApplication::UnicodeUTF8));
