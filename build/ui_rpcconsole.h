...
public:
    ...
    QPushButton *openConfigurationfileButton;
    QWidget *tab_console;
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        labelConfigfile = new QLabel(tab_info);
        labelConfigfile->setObjectName(QString::fromUtf8("labelConfigfile"));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        labelConfigfile->setFont(font);

        gridLayout->addWidget(labelConfigfile, 15, 2, 1, 1);
        ...
        horizontalSpacer = new QSpacerItem(404, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer, 18, 3, 2, 1);
        ...
        gridLayout->addWidget(startupTime, 6, 2, 1, 1);
        ...
        gridLayout->addWidget(numberOfConnections, 8, 2, 1, 1);
        ...
        gridLayout->addWidget(isTestNet, 9, 2, 1, 1);
        ...
        gridLayout->addWidget(berkeleyDBVersion, 4, 2, 1, 1);
        ...
        gridLayout->addWidget(buildDate, 5, 2, 1, 1);
        ...
        openConfigurationfileButton = new QPushButton(tab_info);
        openConfigurationfileButton->setObjectName(QString::fromUtf8("openConfigurationfileButton"));
        openConfigurationfileButton->setAutoDefault(false);

        gridLayout->addWidget(openConfigurationfileButton, 16, 2, 1, 1);
        ...
        lblBytesIn->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);
        ...
        lblBytesOut->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "indicoin - Debug window", 0, QApplication::UnicodeUTF8));
        labelConfigfile->setText(QApplication::translate("RPCConsole", "Configuration file", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the indicoin debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the indicoin-Qt help message to get a list with possible indicoin command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        label_9->setText(QApplication::translate("RPCConsole", "indicoin Core", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        openConfigurationfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the indicoin configuration file from the current data directory.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        openConfigurationfileButton->setText(QApplication::translate("RPCConsole", "O&pen", 0, QApplication::UnicodeUTF8));
