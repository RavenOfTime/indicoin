...
public:
    ...
    void setupUi(QFrame *MultisigInputEntry)
    {
        ...
        transactionIdLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);
        ...
        transactionOutputLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);
        ...
        redeemScriptLabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignCenter);
