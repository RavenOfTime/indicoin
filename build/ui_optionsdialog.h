...
public:
    ...
    QLabel *externalSeederLabel;
    QLineEdit *externalSeederCommand;
    QPushButton *chooseSeeder;
    ...
    void setupUi(QWidget *OptionsDialog)
    {
        ...
        externalSeederLabel = new QLabel(tabNetwork);
        externalSeederLabel->setObjectName(QString::fromUtf8("externalSeederLabel"));

        horizontalLayout_3->addWidget(externalSeederLabel);

        externalSeederCommand = new QLineEdit(tabNetwork);
        externalSeederCommand->setObjectName(QString::fromUtf8("externalSeederCommand"));

        horizontalLayout_3->addWidget(externalSeederCommand);

        chooseSeeder = new QPushButton(tabNetwork);
        chooseSeeder->setObjectName(QString::fromUtf8("chooseSeeder"));

        horizontalLayout_3->addWidget(chooseSeeder);


        verticalLayout_Network->addLayout(horizontalLayout_3);
    ...
    void retranslateUi(QWidget *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start indicoin after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start indicoin on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the indicoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        externalSeederLabel->setText(QApplication::translate("OptionsDialog", "Seeder command:", 0, QApplication::UnicodeUTF8));
        chooseSeeder->setText(QApplication::translate("OptionsDialog", "Choose ...", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting indicoin.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show indicoin addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
