...
static const char qt_meta_stringdata_OptionsDialog[] = {
    ...
    "torIpValid(QValidatedLineEdit*,bool)\0"
    ...
    "showRestartWarning_Tor()\0"
    "showRestartWarning_Lang()\0"
    "showRestartWarning_URL()\0updateDisplayUnit()\0"
    "object,fState\0"
    "handleProxyIpValid(QValidatedLineEdit*,bool)\0"
    "handleTorIpValid(QValidatedLineEdit*,bool)\0"
    "on_chooseSeeder_clicked()\0"
};
...
void OptionsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->torIpValid((*reinterpret_cast< QValidatedLineEdit*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        ...
        case 11: _t->showRestartWarning_Tor(); break;
        case 12: _t->showRestartWarning_Lang(); break;
        case 13: _t->showRestartWarning_URL(); break;
        case 14: _t->updateDisplayUnit(); break;
        case 15: _t->handleProxyIpValid((*reinterpret_cast< QValidatedLineEdit*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 16: _t->handleTorIpValid((*reinterpret_cast< QValidatedLineEdit*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 17: _t->on_chooseSeeder_clicked(); break;
        default: ;
        }
    }
}
...
const QMetaObject OptionsDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_OptionsDialog,
...
// SIGNAL 1
void OptionsDialog::torIpValid(QValidatedLineEdit * _t1, bool _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
