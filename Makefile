#############################################################################
# Makefile for building: indicoin-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Jun 10 07:34:19 2017
# Project:  indicoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake USE_O3\ =\ 1\ USE_ASM\ =\ 1 -o Makefile indicoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -m64 -pipe -O3 -D_REENTRANT -Wall -W $(DEFINES)
CXXFLAGS      = -m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O3 -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wno-unused-local-typedef -Wstack-protector $(DEFINES)
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/txdb-bdb.cpp \
		...
		src/cryptogram.cpp \
		src/ecies.cpp \
		src/ipcollector.cpp build/moc_bitcoingui.cpp \
		build/moc_intro.cpp \
		...
		build/moc_secondauthdialog.cpp \
		qrc_bitcoin.cpp
OBJECTS       = build/txdb-bdb.o \
		build/scrypt-generic.o \
		build/bitcoin.o \
		build/bitcoingui.o \
		build/intro.o \
...
$(TARGET): /home/sarkar/indicoinagain/indicoin/build/build.h build/ui_intro.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_multisigaddressentry.h build/ui_multisiginputentry.h build/ui_multisigdialog.h build/ui_secondauthdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: indicoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_O3\ =\ 1\ USE_ASM\ =\ 1 -o Makefile indicoin-qt.pro
...
/home/sarkar/indicoinagain/indicoin/build/build.h: FORCE
	cd /home/sarkar/indicoinagain/indicoin; /bin/sh share/genbuild.sh /home/sarkar/indicoinagain/indicoin/build/build.h
...
compiler_TSQM_make_all: src/qt/locale/bitcoin_en.qm src/qt/locale/bitcoin_ru.qm src/qt/locale/bitcoin_uk.qm
compiler_TSQM_clean:
	-$(DEL_FILE) src/qt/locale/bitcoin_en.qm src/qt/locale/bitcoin_ru.qm src/qt/locale/bitcoin_uk.qm
...
build/moc_secondauthdialog.cpp: src/qt/secondauthdialog.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/secondauthdialog.h -o build/moc_secondauthdialog.cpp
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/indicoin-16.png \
		src/qt/res/icons/indicoin-128.png \
...
build/ui_secondauthdialog.h: src/qt/forms/secondauthdialog.ui \
		src/qt/qvalidatedlineedit.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic src/qt/forms/secondauthdialog.ui -o build/ui_secondauthdialog.h
...
build/txdb-bdb.o: src/txdb-bdb.cpp src/db.h \
		src/main.h \
		src/timestamps.h \
		src/bignum.h \
		src/util.h \
		...
		src/checkpoints.h \
		src/txdb-bdb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/txdb-bdb.o src/txdb-bdb.cpp

build/scrypt-generic.o: src/crypto/scrypt/generic/scrypt-generic.cpp src/scrypt.h \
		src/uint256.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/scrypt-generic.o src/crypto/scrypt/generic/scrypt-generic.cpp
...
build/stun.o: src/stun.cpp src/ministun.h \
		src/netbase.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		src/compat.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/stun.o src/stun.cpp
...
build/rpccrypt.o: src/rpccrypt.cpp src/wallet.h \
		src/main.h \
		src/timestamps.h \
		src/bignum.h \
		src/util.h \
		...
		src/checkpoints.h \
		src/init.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/rpccrypt.o src/rpccrypt.cpp
...
build/kernel_worker.o: src/kernel_worker.cpp src/uint256.h \
		src/bignum.h \
		src/util.h \
		src/netbase.h \
		src/serialize.h \
		...
		src/db.h \
		src/kernel_worker.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/kernel_worker.o src/kernel_worker.cpp
...
build/secondauthdialog.o: src/qt/secondauthdialog.cpp src/qt/secondauthdialog.h \
		build/ui_secondauthdialog.h \
		src/qt/qvalidatedlineedit.h \
		src/qt/addressbookpage.h \
		src/base58.h \
		src/bignum.h \
		...
		src/qt/optionsmodel.h \
		src/qt/walletmodel.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/secondauthdialog.o src/qt/secondauthdialog.cpp

build/base58.o: src/base58.cpp src/bignum.h \
		src/util.h \
		src/uint256.h \
		src/netbase.h \
		src/serialize.h \
...
build/cryptogram.o: src/cryptogram.cpp src/ies.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/cryptogram.o src/cryptogram.cpp

build/ecies.o: src/ecies.cpp src/ies.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/ecies.o src/ecies.cpp

build/ipcollector.o: src/ipcollector.cpp src/net.h \
		src/mruset.h \
		src/netbase.h \
		src/serialize.h \
		src/allocators.h \
		...
		src/sync.h \
		src/hash.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/ipcollector.o src/ipcollector.cpp
...
build/moc_secondauthdialog.o: build/moc_secondauthdialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_secondauthdialog.o build/moc_secondauthdialog.cpp
