...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/indicoin/tx/%s|https://coinplorer.com/INC/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/INC/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/indicoin/tx/%s|https://coinplorer.com/INC/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/INC/tx/%s").toString();
