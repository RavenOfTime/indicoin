...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("indicoins"));
    case mBTC: return QString(QObject::tr("Milli-indicoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-indicoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
